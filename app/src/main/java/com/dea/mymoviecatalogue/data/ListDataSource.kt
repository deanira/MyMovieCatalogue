package com.dea.mymoviecatalogue.data

import androidx.lifecycle.MutableLiveData
import androidx.paging.DataSource
import androidx.paging.PositionalDataSource

class ListDataSource<T : Any>(private val items: List<T>) : DataSource.Factory<Int, T>() {
    ...
    class FakeDataSource<T : Any>(var items: List<T>) : PositionalDataSource<T>() {
